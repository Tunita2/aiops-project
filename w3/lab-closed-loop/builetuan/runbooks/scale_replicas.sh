...
#
# Note: Docker Compose v2 supports --scale for services without fixed
#       container_name. In this lab the services have container_name set,
#       so scaling to N>1 is illustrative. The script demonstrates the
#       pattern; real production use would target K8s or Docker Swarm.
#
# Exit codes:
