...
def load_features(csv_path: str) -> pd.DataFrame:
    """Đọc CSV, validate schema, trả về DataFrame chỉ chứa feature columns."""
...
def train(
    ...
    """Train IsolationForest, log experiment vào MLflow, register model."""
    tracking_uri = os.environ.get("MLFLOW_TRACKING_URI", "http://localhost:5000")
    mlflow.set_tracking_uri(tracking_uri)
    mlflow.set_experiment(EXPERIMENT_NAME)

    # Load và scale features
    ...
    with mlflow.start_run() as run:
        ...
        # Log scaler as artifact (cần cho serving vì model train trên scaled data)
        ...
        # Log model + register vào Model Registry
    ...
    # Set alias 'production' cho version mới nhất
